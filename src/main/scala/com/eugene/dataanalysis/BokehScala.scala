...
object BokehScala extends App{
    ...
    val diamond = new Diamond()
            ...
            .y(petal_width)
            .size(10)
    diamond.fill_color(speciesColor)
    diamond.fill_alpha(0.5)
...
object BreezeSource {
    ...
    val iris = csvread(file = new File("src/main/resources/irisNumeric.csv"), separator = ',')
